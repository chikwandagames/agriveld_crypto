...
{
    const char* pszTimestamp = "05/Oct/2011 Steve Jobs, Apple’s Visionary, Dies at 56";
    const CScript genesisOutputScript = CScript() << ParseHex("091084710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        // Port for syncing data with other nodes
        // Bitcoin port == 8333, Litecoin port == 9333
        nDefaultPort = 6333;
        nPruneAfterHeight = 100000;
        m_assumed_blockchain_size = 22;
        m_assumed_chain_state_size = 3;

        genesis = CreateGenesisBlock(1636449316, 2001428073, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x641c4281b981bb30afca875088e8640d26e923e1d389424a5d539fb9068b8357"));
        assert(genesis.hashMerkleRoot == uint256S("0x4b37a7ae049fee1b0054552162250c7c443fccba11f26b8beeeb5e3258e9a930"));
        ...
        // Changed 48 to 23 because Agri... starts with an A
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 3.5 * 24 * 60 * 60; // 3.5 days
        // Set block interval of 1 minute
        consensus.nPowTargetSpacing = 1 * 60;
        ...
        genesis = CreateGenesisBlock(1636449316, 1559229, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x016c50497c754d6ae0fa846ec25a4523ecd775a2de536cf73a68853996209b0c"));
        assert(genesis.hashMerkleRoot == uint256S("0x4b37a7ae049fee1b0054552162250c7c443fccba11f26b8beeeb5e3258e9a930"));
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // Change block inteval to 1 minute
        consensus.nPowTargetSpacing = 1 * 60;
        consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        genesis = CreateGenesisBlock(1636449316, 0, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x86d87c103c5a84ff62a72d7ae3180518e10e8c56970cb6400e25ad3b764ab57d"));
        assert(genesis.hashMerkleRoot == uint256S("0x4b37a7ae049fee1b0054552162250c7c443fccba11f26b8beeeb5e3258e9a930"));
